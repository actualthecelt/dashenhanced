...
file = open(r"C:\Users\Celt\dashenhanced\main\deps\dep1\users\user2_settings.txt", "r")
read = file.read()
        ...
        while setting != "back":
            ...
            if setting == "1":
                if setting1 == "✅":
                    ...
                    with open(r"C:\Users\Celt\dashenhanced\main\deps\dep1\users\user2_settings.txt", 'w') as file:
                        file.write(filedata)
                elif setting1 == "❎":
