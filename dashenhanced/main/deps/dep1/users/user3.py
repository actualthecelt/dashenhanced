...
file = open(r"C:\Users\Celt\dashenhanced\main\deps\dep1\users\user3_settings.txt", "r")
read = file.read()
    ...
    if command == "devlogs":
        ...
        while appcmd != "back":
            ...
            if appcmd == "inbox":
                ...
                print("MESSAGE INBOX \n")
                cur.execute("SELECT rowid, * FROM dep1_user2_messages ORDER BY rowid")
                ...
                wait()
                cur.execute("DELETE FROM dep1_user2_messages;")
                con.commit() 
            elif appcmd == "msg":
                ct()
                print("[logged in] | Home | > APPS < | Settings | Changelogs " + dtime + "\n")
                ...
                if usermsg == "1":
                    ...
                    print("[logged in] | Home | > APPS < | Settings | Changelogs " + dtime + "\n")
                    print("SEND MESSAGE \n")
                    print("What do you want to send to User1?\n")
                    msg = input("> ")
                    cur.execute("INSERT INTO dep1_user1_messages VALUES ('" + msg + "')")
                    con.commit()
                    ct()
        ...
        while setting != "back":
            ...
            if setting == "1":
                if setting1 == "✅":
                    ...
                    with open(r"C:\Users\Celt\dashenhanced\main\deps\dep1\users\user3_settings.txt", 'w') as file:
                        file.write(filedata)
                elif setting1 == "❎":
